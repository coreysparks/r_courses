---
title: "DEM 7263 Bayesian Regression using the INLA Approximation"
...
with
$$u_j \sim N(0, \tau_u) \text{  and } e\sim N(0, \tau_e) $$
...
$$v_j \sim N(\frac{1}{\boldsymbol{N}_{i\neq j}} \sum a_{ij}u_j, \tau_v)$$
