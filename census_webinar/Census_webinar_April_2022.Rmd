...
### About Me
I am an associate professor at the Univerity of Texas at San Antonio in the [UTSA Department of Demography](https://hcap.utsa.edu/demography/) and have been there since 2006. 

Research interests include data science, Bayesian methods, education demography and health disparities.

You can find me on [Twitter](https://twitter.com/CoreySparks1) and [Github ](https://github.com/coreysparks) and my [emailmailto:corey.sparks@utsa.edu>.
...
They [tidycensus](https://github.com/walkerke/tidycensus) is a package for the R statistical programming language and is related to the [`tidyverse`](https://www.tidyverse.org/), and was written and maintained by [Dr. Kyle Walker](http://personal.tcu.edu/kylewalker/) at Texas Christian Univeristy.
...
Here I load the 2019 5-year ACS variabls from the data profile tables, and search for a keyword
