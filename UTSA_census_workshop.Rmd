...
1) About me
2) Using Rstudio on shamu
3) Types of census data
4) The Census API
...
##Using Rstudio on shamu
[Request Shamu account](http://www.utsa.edu/oit/AboutUs/RCSG/HPC.html)

I would recommend [MobaXterm](https://mobaxterm.mobatek.net/) for accessing Shamu.

Shamu [FAQ](http://hpcsupport.utsa.edu/foswiki/bin/view/Main/WebHome), which is **very** helpful.
...
![log in](C:/Users/ozd504/Google Drive/talks/login.PNG)

###Get a compute node
At the login node, type `qlogin` and you will be on a computation node. 
![qlogin](C:/Users/ozd504//Google Drive/talks/qlogin.PNG)

###Load modules
You need to first load the R 3.5.1 module
![R](C:/Users/ozd504//Google Drive/talks/loadr.PNG)

then the Rstudio 1.1.383
![Rstudio](C:/Users/ozd504//Google Drive/talks/loadrstudio.PNG)

then you run Rstudio!
![run it!](C:/Users/ozd504//Google Drive/talks/rstudio.PNG)

And you see your old friend:
![run it!](C:/Users/ozd504/Google Drive/talks/rstudiowindow.PNG)
...
![IPUMS - Waiting](C:/Users/ozd504/Google Drive/talks/ipums1.PNG)

![IPUMS - Data](C:/Users/ozd504/Google Drive/talks/ipums2.PNG)
