...
1.  Install base R using the appropriate installer for your computer (Windows, Mac, Linux) If you already have an R version installed on your computer, it's best to install the current version.
...
- [Rtools download (windows only)](https://cran.r-project.org/bin/windows/Rtools/) - install the version matching your installed R version.
