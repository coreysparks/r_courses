---
title: "R Bootcamp for Demography Graduate Students - Day 1"
...
Steps:
  ...
  1. Install base R using the appropriate installer for your computer (Windows, Mac, Linux)
If you already have an R version installed on your computer, it’s best to install the current version (4.1.1 as of this document)
...
### Links:
 ...
 - [Rtools download (windows only)](https://cran.r-project.org/bin/windows/Rtools/rtools40v2-x86_64.exe) 
